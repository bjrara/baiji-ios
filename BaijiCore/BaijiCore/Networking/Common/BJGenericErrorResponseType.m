 ...
 */
#import "BJGenericErrorResponseType.h"
#import "BJError.h"
...
- (BOOL)isEqual:(id)object {
    ...
    if ([self class] != [object class])
        return NO;
    BJGenericErrorResponseType *that = (BJGenericErrorResponseType *)object;
    return
